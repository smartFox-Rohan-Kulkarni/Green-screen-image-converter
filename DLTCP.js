...
#Upated Sections of the code to suit requirment. 
*/
...
//Added by  Rohan Kulkarni

// global variables to access original file and filtered image files.
var image_org=null, image_grey=null;

//fuction to access and store uploadedfile. Uses the SimpleImage defined above.
function upload(){
    var canvas = document.getElementById("canvas1");
    var finput = document.getElementById("finput");
    image_org = new SimpleImage(finput);
    image_grey = new SimpleImage(finput);
    image_org.drawTo(canvas);
}

//fuction to apply grey scale filter and render filtered image.
function makeGrey() {
    for (var pixel of image_grey.values()){
        geryVal = (pixel.getRed()+pixel.getGreen()+pixel.getBlue())/3;
        pixel.setRed(geryVal);
        pixel.setGreen(geryVal);
        pixel.setBlue(geryVal);
    }
    
    var canvas = document.getElementById("canvas1");
    image_grey.drawTo(canvas);
}

//fucntion the resets/ renders the orignal image on the canvas.
function reset(){
    var canvas = document.getElementById("canvas1");
    image_org.drawTo(canvas);
}
...
var fgImage = null, bgImage = null, GreenThreshold = 200, RBThreshold = 160 ;

function uploadForegroundImage(){
    var canvas = document.getElementById("canvas1");
    var finput = document.getElementById("foregroundInput");
...
function uploadBackgroundImage(){
    ...
    var finput = document.getElementById("backgroundInput");
...
function createComposite(){
    ...
    //Otherwise, have the function clear both canvases and execute the green screen algorithm.
...
function clearAllImages(){
    var i;
    for(i=1;i<4;i++){
        var canvas = document.getElementById("canvas"+String(i));
